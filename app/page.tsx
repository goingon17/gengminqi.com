    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-bottom">
            <p>全同态加密让机器在<span className="marker">看不见数据</span>的情况下完成计算。把数据放进保险箱锁好，在不被打开的情况下照样完成运算。</p>
        ...
        <div className="cipher-orbit" aria-hidden="true">
          ...
          <span className="orbit-label label-a">compute</span><span className="orbit-label label-b">encrypt</span><span className="orbit-label label-c">decrypt</span>
        </div>
      </section>
      ...
      <section className="lab-section" id="lab">
        <div className="section-heading inverse">
          <div className="section-label"><span>02</span> 试一次</div>
          <div><h2>把数字锁起来，<br />再让它参与运算。</h2><p>下面是一个帮助理解流程的可视化模拟，并未在浏览器中执行真正的 FHE。</p></div>
        </div>
        <FheLab />
      </section>
      ...
      <section className="editorial-section" id="mechanism">
        ...
        <div className="mechanism-intro"><h2>它为什么<br />真的能运行？</h2><p>粗略地说，FHE 把一个消息藏进带有可控噪声的数学结构中。密文保留了某些代数关系，因此加法与乘法能够在不知道明文的前提下被映射过去。</p></div>
      ...
      <section className="reality-section">
        ...
        <div className="reality-grid"><div className="reality-title"><p className="kicker">Powerful ≠ universal</p><h2>什么时候<br />值得用 FHE？</h2></div><div className="use-columns">
          <div><span className="use-icon yes">✓</span><h3>尤其适合</h3><ul><li>云端处理高度敏感的数据</li><li>跨机构联合统计与风险分析</li><li>隐私机器学习推理</li><li>无法信任计算环境的场景</li></ul></div>
          <div><span className="use-icon no">×</span><h3>不是默认答案</h3><ul><li>速度和延迟通常比明文计算更差</li><li>算法要改写成受支持的电路</li><li>参数选择影响安全与性能</li><li>简单的访问控制可能已经足够</li></ul></div>
        </div></div>
      </section>
